...
const scenes = ['intro', 'constellation', 'book', 'universe', 'garden', 'letter'];
...
document.getElementById('letterTurnPageBtn').addEventListener('click', () => {
  // Scene 6 — Time — not built yet. Coming next.
  console.log('Turn the page → Scene 6 (Time) not built yet.');
});
