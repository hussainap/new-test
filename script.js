...
const scenes = ['intro', 'constellation', 'book', 'universe', 'garden', 'letter', 'time'];
...
document.getElementById('timeContinueBtn').addEventListener('click', () => {
  // Scene 7 — Our Little Corner — not built yet. Coming next.
  console.log('Continue → Scene 7 (Our Little Corner) not built yet.');
});
